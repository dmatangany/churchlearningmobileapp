...
import 'package:lesson_delivery_app_ui/Utils/snackbar.dart';
import 'package:lesson_delivery_app_ui/screens/contact_screen.dart';
                                      ...
                                      children: <Widget>[
                                        ...
                                        Row(
                                          children: [
                                            GestureDetector(
                                              onTap: () {
                                                cartProvider.decrementQuantity(order);
                                              },
                                              child: Container(
                                                width: 25.0,
                                                height: 25.0,
                                            ...
                                            GestureDetector(
                                              onTap: () {
                                                cartProvider.incrementQuantity(order);
                                              },
                                              child: Container(
                                                width: 25.0,
                                                height: 25.0,
